...
// goes out), and on beforeunload delivers the queue via navigator.sendBeacon for reliable
// last-mile delivery (a plain fetch without keepalive is cancelled on page-discard). DOM
